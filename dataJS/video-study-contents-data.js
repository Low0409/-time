  ...
  data: {
    StudyServiceList: [
      ...
      },
      {
        ...
        description:
          "NewsPicksは、日本のソーシャル型オンライン経済メディア、ニュースサイトです。国内外90以上のメディアから経済ニュースを配信。@timeなら無料で",
      },
      {
        name: "flier",
        img: "../../img/services/business/flier.png",
        description:
          "flier（フライヤー）は本の要約サービス。1冊10分、忙しくてもスキマ時間で効率よくインプット。 ベストセラーから新刊まで2,600冊以上︕今読むべきビジネス書に出会える、時短読書サービス。 スキマ時間でインプット・1冊10分で読める要約。",
      },
      {
        name: "LEC東京リーガルマインド",
